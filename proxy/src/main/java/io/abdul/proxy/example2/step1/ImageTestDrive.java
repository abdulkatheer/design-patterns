package io.abdul.proxy.example2.step1;
...
public class ImageTestDrive {
    ...
    public ImageTestDrive() throws Exception {
        ...
        for (Enumeration<String> e = albums.keys(); e.hasMoreElements(); ) {
            ...
            menuItem.addActionListener(event -> {
                imageComponent.setIcon(new ImageIcon(getAlbumUrl(event.getActionCommand()), "Album Cover"));
                frame.repaint();
            });
        }

        // set up frame and menus
        Icon icon = new ImageIcon((initialURL), "Album Cover");
    ...
    public static void main(String[] args) throws Exception {
        ImageTestDrive testDrive = new ImageTestDrive();
    }
